...
class Lectio:
    ...
    def __init__(self, Username, Password, SchoolId):
        ...
        if (studentIdFind == None):
            ...
            self.studentId = (studentIdFind['href']).replace(
                "/lectio/" + self.SchoolId + "/forside.aspx?elevid=", '')
    ...
    def getExercise(self, ExerciseId):
        result = exercise.exercise(
            self, self.Session, self.SchoolId, self.studentId, ExerciseId)

        return result

    def getExercises(self):
        result = exercises.exercises(
            self, self.Session, self.SchoolId, self.studentId)
    ...
    def getMessage(self, MessageId):
        result = message.message(
            self, self.Session, self.SchoolId, self.studentId, MessageId)
    ...
    def getStudyProgramme(self):
        result = studyProgramme.studyProgramme(
            self, self.Session, self.SchoolId, self.studentId)
    ...
    def getUnreadMessages(self):
        result = unreadMessages.unreadMessages(
            self, self.Session, self.SchoolId)
